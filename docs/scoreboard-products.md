...
|---|---|---|---|---|---|
| price | **sluicer 0.3.0** | 0.750 ± 0.034 | 0.888 | 0.649 | 134 |
...
| availability | **sluicer 0.3.0** | 0.907 ± 0.026 | 0.907 | 0.907 | 140 |
...
| InStock | **sluicer 0.3.0** | 0.950 ± 0.014 | 0.954 | 0.947 | 131 |
...
| OutOfStock | **sluicer 0.3.0** | 0.316 ± 0.140 | 0.300 | 0.333 | 9 |
