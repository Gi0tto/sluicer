...
Regenerated on 2026-09-24 from commit `2dacf12` by `uv run bench/products.py`, against the benchmark at `cba97d7a8d42`. Sluicer read the 140 pages in 1.2 s.
...
|---|---|---|---|---|---|
| price | **sluicer 0.6.0** | 0.750 ± 0.034 | 0.888 | 0.649 | 134 |
...
| sku | **sluicer 0.6.0** | 0.541 ± 0.046 | 0.778 | 0.415 | 135 |
...
| availability | **sluicer 0.6.0** | 0.907 ± 0.026 | 0.907 | 0.907 | 140 |
...
| InStock | **sluicer 0.6.0** | 0.950 ± 0.014 | 0.954 | 0.947 | 131 |
...
| OutOfStock | **sluicer 0.6.0** | 0.316 ± 0.140 | 0.300 | 0.333 | 9 |
