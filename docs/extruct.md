...
|---|---|---|---|
| JSON-LD | 356 / 360 | 140 / 140 | 33 / 33 |
| microdata | 358 / 360 | 138 / 140 | 33 / 33 |
| OpenGraph | 360 / 360 | 140 / 140 | 33 / 33 |
| RDFa | 360 / 360 | 140 / 140 | 33 / 33 |
| microformats | 360 / 360 | 140 / 140 | 33 / 33 |
| Dublin Core | 47 / 360 | 6 / 140 | 27 / 33 |
| uniform microdata | 358 / 360 | 138 / 140 | 33 / 33 |
| uniform OpenGraph | 360 / 360 | 140 / 140 | 33 / 33 |
| uniform microformats | 360 / 360 | 140 / 140 | 33 / 33 |
| uniform Dublin Core | 47 / 360 | 6 / 140 | 27 / 33 |

`extruct.extract(html, base_url=url)`, every argument else at its default, raises on 4 of the 533 pages; sluicer's raises on none. The same call over every page takes 27.0 s in extruct and 19.2 s in sluicer, the median of five passes measured as [speed and weight](speed.md) says.
...
| Dublin Core | not Dublin Core | 453 | sluicer: extruct files any name after its last dot, so `description`, `title` and `rel="license"` are Dublin Core to it | nytimes.com/wirecutter/reviews/best-laptop-under-500/ |

extruct answers Dublin Core on 453 of the 533 pages; 2 of them write a name under a Dublin Core prefix.
