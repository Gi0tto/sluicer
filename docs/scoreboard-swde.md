...
Regenerated on 2026-09-26 from commit `8a426a2` by `uv run bench/swde.py`, against the mirror at `e9b60dbbcb89`, every
...
|---|---|---|---|
| **sluicer 0.9.1** | 0.850 (0.81–0.89) | 0.974 (0.95–0.99) | 0.849 (0.80–0.89) |
...
|---|---|---|---|
| **sluicer 0.9.1** | 11,156 | 1,999 (18%) | 20 of 320 |
