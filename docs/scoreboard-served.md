...
Regenerated on 2026-09-25 from commit `83186aa` by
...
|---|---|---|---|---|---|---|---|---|---|---|
| sluicer 0.8.0 | title | 360 | 0.714 (0.66–0.76) | **0.708 (0.65–0.76)** | 0.714 (0.66–0.76) | **0.708 (0.65–0.76)** | 103 | 105 | 0 | 0 |
| sluicer 0.8.0 | author | 129 | 0.450 (0.36–0.54) | **0.690 (0.60–0.77)** | 0.644 (0.54–0.74) | **0.636 (0.55–0.72)** | 9 | 7 | 23 | 44 |
| sluicer 0.8.0 | date | 159 | 0.585 (0.50–0.66) | **0.780 (0.70–0.84)** | 0.939 (0.87–0.98) | **0.734 (0.66–0.80)** | 1 | 9 | 5 | 36 |
...
|---|---|---|---|---|
| sluicer 0.8.0 | title | hit rate | -0.006 (-0.045 to +0.034) | inconclusive |
| sluicer 0.8.0 | title | right when answering | -0.006 (-0.045 to +0.034) | inconclusive |
| sluicer 0.8.0 | author | hit rate | +0.240 (+0.168 to +0.317) | better |
| sluicer 0.8.0 | author | right when answering | -0.009 (-0.080 to +0.064) | inconclusive |
| sluicer 0.8.0 | date | hit rate | +0.195 (+0.125 to +0.268) | better |
| sluicer 0.8.0 | date | right when answering | -0.206 (-0.273 to -0.142) | worse |
...
| sluicer 0.8.0, declared | author | hit rate | +0.062 (+0.023 to +0.109) | better |
| sluicer 0.8.0, declared | author | right when answering | +0.007 (-0.015 to +0.028) | inconclusive |
| sluicer 0.8.0, declared | date | hit rate | +0.075 (+0.037 to +0.119) | better |
| sluicer 0.8.0, declared | date | right when answering | -0.033 (-0.063 to -0.004) | worse |
| trafilatura 2.2.0 | title | hit rate | -0.047 (-0.095 to +0.003) | inconclusive |
| trafilatura 2.2.0 | title | right when answering | -0.047 (-0.095 to +0.003) | inconclusive |
...
|---|---|---|---|---|---|---|---|---|
| sluicer 0.8.0 | title | 255 | 105 | 0 | 0 | 0 | 0.708 (0.65–0.76) | 0.708 (0.65–0.76) |
| sluicer 0.8.0 | author | 89 | 7 | 33 | 187 | 44 | 0.690 (0.60–0.77) | 0.636 (0.55–0.72) |
| sluicer 0.8.0 | date | 124 | 9 | 26 | 165 | 36 | 0.780 (0.70–0.84) | 0.734 (0.66–0.80) |
...
| tool | field | hit | wrong | silent miss | correct silence | invention | hit rate | right when answering |
|---|---|---|---|---|---|---|---|---|
| sluicer 0.8.0 | title | 257 | 103 | 0 | 0 | 0 | 0.714 (0.66–0.76) | 0.714 (0.66–0.76) |
| sluicer 0.8.0 | author | 58 | 9 | 62 | 208 | 23 | 0.450 (0.36–0.54) | 0.644 (0.54–0.74) |
| sluicer 0.8.0 | date | 93 | 1 | 65 | 196 | 5 | 0.585 (0.50–0.66) | 0.939 (0.87–0.98) |
| trafilatura 2.2.0 | title | 272 | 88 | 0 | 0 | 0 | 0.756 (0.70–0.80) | 0.756 (0.70–0.80) |
