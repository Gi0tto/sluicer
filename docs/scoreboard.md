...
|---|---|---|---|---|---|
| sluicer 0.8.0 | 0.727 (0.68–0.77) | 0.532 (0.46–0.61) | 0.581 (0.52–0.64) | 42 | 8 |
...
| tool | title | author | date | authors invented | dates invented |
|---|---|---|---|---|---|
| sluicer 0.8.0 | 0.748 (0.70–0.80) | 0.532 (0.46–0.61) | 0.598 (0.53–0.67) | 18 | 3 |
...
| sluicer 0.8.0, declared | author | hit rate | +0.117 (+0.072 to +0.165) | better |
| sluicer 0.8.0, declared | author | right when answering | +0.006 (-0.025 to +0.037) | inconclusive |
| sluicer 0.8.0, declared | date | hit rate | +0.136 (+0.095 to +0.179) | better |
| sluicer 0.8.0, declared | date | right when answering | -0.094 (-0.137 to -0.055) | worse |
| trafilatura 2.2.0 | title | hit rate | -0.018 (-0.052 to +0.016) | inconclusive |
| trafilatura 2.2.0 | title | right when answering | -0.018 (-0.051 to +0.016) | inconclusive |
...
|---|---|---|---|---|---|---|---|---|
| sluicer 0.8.0 | title | 370 | 139 | 0 | 1 | 1 | 0.727 (0.68–0.77) | 0.725 (0.68–0.77) |
| sluicer 0.8.0 | author | 100 | 11 | 77 | 281 | 42 | 0.532 (0.46–0.61) | 0.654 (0.57–0.73) |
| sluicer 0.8.0 | date | 154 | 6 | 105 | 238 | 8 | 0.581 (0.52–0.64) | 0.917 (0.86–0.95) |
...
| tool | field | hit | wrong | silent miss | correct silence | invention | hit rate | right when answering |
|---|---|---|---|---|---|---|---|---|
| sluicer 0.8.0 | title | 267 | 90 | 0 | 1 | 1 | 0.748 (0.70–0.80) | 0.746 (0.69–0.79) |
| sluicer 0.8.0 | author | 100 | 11 | 77 | 153 | 18 | 0.532 (0.46–0.61) | 0.775 (0.69–0.84) |
| sluicer 0.8.0 | date | 134 | 3 | 87 | 132 | 3 | 0.598 (0.53–0.67) | 0.957 (0.90–0.99) |
