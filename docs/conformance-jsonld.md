...
| Sluicer's JSON-LD reader 0.8.0 | 0.480 (0.34–0.62) | 11/21 | 1/4 | 2/5 | 10/20 | 7/15 |
| sluicer.compat.extruct 0.8.0 | 0.660 (0.52–0.78) | 15/21 | 2/4 | 2/5 | 14/20 | 13/15 |
...
|---|---|---|---|
| Sluicer's JSON-LD reader 0.8.0 | extruct 0.18.0 | -0.180 (-0.300 to -0.079) | worse |
| Sluicer's JSON-LD reader 0.8.0 | sluicer.compat.extruct 0.8.0 | -0.180 (-0.300 to -0.079) | worse |
