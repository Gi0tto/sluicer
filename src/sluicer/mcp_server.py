...
``read_feed``, ``map_site``, ``crawl_site`` and ``select_values`` -- expose
what the library does and add no logic of their own beyond bounds: a map
or a crawl an agent starts is small and has a clock.
